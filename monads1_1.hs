...
formatejarBindMb1 str = mins str >>= majInici >>= carFin '.'
...
formatejarDoMb2 str = do
    s1 <- limit 10 str 
    s2 <- noNumIni s1
    formatejarBindMb1 s2
